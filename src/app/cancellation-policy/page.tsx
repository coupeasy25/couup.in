      ...
      <Container>
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl border border-neutral-200">
          ...
          <div className="space-y-6 text-neutral-600 leading-relaxed">
            <p>At Couup, we strive to make the cancellation and refund process as smooth as possible.</p>
            
            <div>
              <h2 className="text-lg font-medium text-neutral-800 mb-2">1. Cancellation Rules</h2>
            ...
            <div>
              <h2 className="text-lg font-medium text-neutral-800 mb-2">2. Refund Processing</h2>
            ...
            <div>
              <h2 className="text-lg font-medium text-neutral-800 mb-2">3. Processing Time</h2>
              <p>Once a refund is approved and initiated, the amount will be credited back to your original payment method (processed securely via Razorpay) within 2 to 3 working days. Please note that your bank or credit card provider may take additional time to reflect the amount in your account.</p>
            </div>

            <div>
              <h2 className="text-lg font-medium text-neutral-800 mb-2">4. Disputes</h2>
